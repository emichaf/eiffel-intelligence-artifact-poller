node{
     ...
     String build_info_file = 'build_info.yml'
		...
		stage ('Trigger EI BackEnd SC Component Jobs') {
            ...
            curl -H "Content-Type: application/json" -X POST -d '{"meta.tags[0]":"frickenwashere"}' http://docker104-eiffel999.lmera.ericsson.se:9900/doit/?msgType=EiffelActivityFinishedEvent
